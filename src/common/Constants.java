...
public class Constants {
	...
	public final static String errCategoryEmpty = "Veuillez renseigner une catégorie";
	...
	public final static String INSERT_PARKING_LOG = "INSERT INTO parkinglot_log(PID,PARKINGLOTID,USERID,FROMDATE,TODATE,"
			+ "PRICE) VALUE(?,?,?,?,?,?)";
	...
	public final static String GET_PARKING_SPACE_Detail = "SELECT PARKINGLOT.PARKINGLOTID, PARKINGCATEGORY.DESCRIPTION, PARKINGCATEGORY.DETAILS, PARKINGLOT.NOOFSPACE,parkinglot.CURRENTPLACE FROM PARKINGLOT JOIN PARKINGCATEGORY ON PARKINGLOT.PARKINGCATEGORYID = PARKINGCATEGORY.PARKINGCATEGORYID";
        public final static String GETPARKINGLOG ="SELECT PARKINGLOT_LOG.USERID, (SELECT USERNAME FROM USERPROFILE WHERE USERID = PARKINGLOT_LOG.USERID) AS USERNAME, (SELECT CONCAT(DESCRIPTION,PARKINGLOT_LOG.PID) FROM PARKINGCATEGORY, PARKINGLOT WHERE PARKINGLOT.PARKINGLOTID = PARKINGLOT_LOG.PARKINGLOTID AND PARKINGLOT.PARKINGCATEGORYID = PARKINGCATEGORY.PARKINGCATEGORYID) AS DESCRIPTION, PARKINGLOT_LOG.FROMDATE,PARKINGLOT_LOG.TODATE FROM PARKINGLOT_LOG";
	...
	public final static String GET_PARKING_LOT = "SELECT PARKINGLOTID , PARKINGCATEGORY.DESCRIPTION AS CATEGORY,"
			...
			+ "PARKINGLOT.NOOFSPACE FROM PARKINGLOT "
